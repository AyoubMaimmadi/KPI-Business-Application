    ...
    <div>
      <Router>
        <div className="flex relativ dark:bg-main-dark-bg">
          ...
          {activeMenu ? <div className="w-72 fixed sidebar dark:bg-secondary-dark-bg">sidbar</div> : <div className="w-0 dark:bg-secondary-dark-bg">sidbar w-0</div>}
          ...
          <div>
            <Routes>
              ...
              <Route path="/ecoomerce" element="ECommerce" />
              {/* pages */}
